...
import { initWithLocalStorage, theme, toggleTheme } from "../../../stores/theme"
...
const ThemeButton: React.FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    ...
    >
      <span className={mergeClassName(styles.wrapper)}>
        {/* light icon */}
        <svg
          ...
          focusable="false"
          viewBox="0 0 24 24"
          className={mergeClassName(styles.sun)}
        >
        ...
        <svg
          ...
          focusable="false"
          viewBox="0 0 24 24"
          className={mergeClassName(styles.moon)}
        >
